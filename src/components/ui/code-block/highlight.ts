...
const jsRules: TokenRule[] = [
  ...
  {
    pattern:
      /\b(const|let|var|function|return|if|else|for|while|import|export|from|class|new|this|async|await|try|catch|throw|typeof|instanceof|of|in|default|switch|case|break|continue|void|delete|yield|extends|implements|interface|type|enum|namespace|declare|abstract|readonly|static|private|public|protected)\b/g,
    color: "error",
  },
...
const pythonRules: TokenRule[] = [
  ...
  {
    pattern:
      /\b(def|class|import|from|return|if|elif|else|for|while|try|except|finally|with|as|in|not|and|or|is|lambda|pass|break|continue|raise|yield|global|nonlocal|del|assert)\b/g,
    color: "error",
  },
...
const bashRules: TokenRule[] = [
  ...
  {
    pattern:
      /\b(if|then|else|elif|fi|for|while|do|done|case|esac|function|return|export|local|readonly|echo|cd|ls|mkdir|rm|cp|mv|grep|awk|sed|curl|cat|chmod|chown)\b/g,
    color: "error",
  },
...
const rulesMap: Record<Language, TokenRule[]> = {
  ...
  css: [
    ...
    {
      pattern: /\b(body|html|div|span|p|a|ul|li|h[1-6]|input|button|form|img|table|tr|td|th)\b/g,
      color: "error",
    },
  ],
  rust: [
    ...
    {
      pattern:
        /\b(fn|let|mut|const|struct|enum|impl|trait|use|mod|pub|self|super|crate|return|if|else|match|for|while|loop|break|continue|async|await|move|ref|where|type|unsafe|extern)\b/g,
      color: "error",
    },
  ...
  go: [
    ...
    {
      pattern:
        /\b(func|var|const|type|struct|interface|map|chan|go|defer|select|case|default|break|continue|goto|fallthrough|return|if|else|for|range|import|package|switch)\b/g,
      color: "error",
    },
